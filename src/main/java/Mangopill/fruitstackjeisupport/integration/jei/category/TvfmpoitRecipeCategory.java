...
import Mangopill.fruitstackjeisupport.integration.RecipeUtils;
...
public class TvfmpoitRecipeCategory implements IRecipeCategory<TvfmpoitRecipe>
{
	...
	@Override
	public void draw(TvfmpoitRecipe recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
		arrow.draw(guiGraphics, 79, 9);
		heatIndicator.draw(guiGraphics, 27, 39);
	}
}
